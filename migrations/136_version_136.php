...
class Migration_Version_136 extends App_module_migration
{
    public function up()
    {
        // Atualização para versão 1.3.6
        
        // Atualizar versão do módulo
        if (!get_option('timesheet_module_version')) {
            add_option('timesheet_module_version', '1.3.6', 1);
        } else {
            update_option('timesheet_module_version', '1.3.6');
        }
    }
    ...
    public function down()
    {
        ...
        update_option('timesheet_module_version', '1.3.5');
    }
}
